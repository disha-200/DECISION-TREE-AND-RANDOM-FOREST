...
class DecisionTree:
    def __init__(self, data, max_depth=5):
        ...
        self.flag = 0  # make flag = 0 for gini criterion
    ...
    def Construct_tree(self,data, attribute_list, min_instances=3):
        node = Node()
    ...
    def Information_gain(self, data, attribute_lists_left, entropy_set):
        ...
        for single_attribute in root_n_attribute_list:
            ...
            for i in range(len(unique_values)):
                entropy_ofvalue = self.entropy_Value_info(data[data[single_attribute] == unique_values[i]])
